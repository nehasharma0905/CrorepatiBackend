...
const randomEasy = await QuestionModel.aggregate(
            [{ $match: { difficulty: "easy" } }
                ,{ $sample: { size: numbers[0] } }]);
                 ...
                 questionArray = [...questionArray ,...randomEasy.map((el, index)=>{
                    return el._id;
                })]
            ...
            [{ $match: { difficulty: "easy" } }
                ...
                questionArray = [...questionArray ,...randomMedium.map((el, index)=>{
                    return el._id;
                })]
            ...
            [{ $match: { difficulty: "easy" } }
                ...
                questionArray = [...questionArray ,...randomHard.map((el, index)=>{
                    return el._id;
                })]
